module powerbi.extensibility.visual {
    ...
    export module ViolinPlotHelpers {
        ...
        /**
         * Creates bare-bones view model, with statistics necessary for rendering dependencies, such as the legend, prior to calculating the remainder of
         * the visual elements in the DOM
         * 
         * @param options                                       - visual update options
         * @param settings                                      - visual settings
         * @param host                                          - visual host
         * @param colourPalette                                 - visual colour palette
         */
        ...
        /**
         * With a basic view model, calculate positioning of all elements, and do KDE on the data. 
         * TODO: we can probably abstract this into its own class so that we don't need to pas sin the view model each time
         * 
         * @param options                                       - Visual update options
         * @param viewModel                                     - Current view model
         * @param settings                                      - Visual settings
         * @param viewport                                      - Visual viewport
         */
